...
- **Reflective prompt mutation** — Proposing prompt edits by reasoning over full game *traces* (turn-by-turn reasoning, actions, verification) rather than over summary metrics alone. → [Chapter 23 — The mutator](./part8-autoresearch/23-prompt-mutation-and-memory.md).
